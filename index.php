...
<html>
	<head>
		...
		<script type="text/javascript" src="js/instadata.js"></script>
		<noscript>
	...
	<body>
		...
		<!-- Header -->
			<section id="header">
				<header>
					<h1>InstaTags</h1>
					<p>By Harsh Kothari</p>
				</header>
				<footer>
<!-- 					<a href="#banner" class="button style2 scrolly">Proceed as anticipated</a>
					
 -->				<input type="text" class="button style2 searchtag" id="searchtag"></input>
 					<a href="#maindiv" class="button style2 scrolly searchclick" id="searchclick">Insta It</a>
				</footer>
			</section>
...
<!-- 			<article class="container box style1 left">
		 ...
		 -->
		<!-- Portfolio -->
		<article class="container box style2 maindiv" id="maindiv">
			<div id="newscreen">
			
			<!-- <div class="rightalign"> -->
				<span id="heading">InstaTags</span>	
				<span id="left">
			<input type="text" class="button style2 searchtag" id="searchtag"></input>
				<a href="#maindiv" class="button style2 scrolly searchclick" id="searchclick">Insta It</a>
			</span></div><!-- </div> -->
			<!-- <header>
				...
				<h2>cricket</h2>
				<p>Total Media for Cricket tag : 344450</p>
			</header> -->
		</article>
<!-- 			<article class="container box style2">
				...
				<div class="inner gallery">
					<div class="row flush insertdata" id="insertdata">
...
<!-- 			<article class="container box style3">
		...
		<section id="footer">
			<ul class="icons">
				<li><a href="http://twitter.com/harshkothari410" class="fa fa-twitter solo"><span>Twitter</span></a></li>
				<li><a href="http://facebook.com/harshkothari410" class="fa fa-facebook solo"><span>Facebook</span></a></li>
			...
			<div class="copyright">
				<ul class="menu">
					<li>&copy; InstaTags. All rights reserved.</li>
					<li>Design: <a href="">InstaTags</a></li>
<!-- 					<li>Demo Images: <a href="http://ineedchemicalx.deviantart.com"></a></li>
 -->				</ul>
			</div>
		</section>
